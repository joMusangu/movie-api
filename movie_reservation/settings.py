...
SECRET_KEY = 'django-insecure-g_nugu2gc$_bp%@kl*snps7%2=js^e558ad@r_!pj0nehc+9ap'
...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware',  # Remove this line to disable CSRF validation
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",  # If your frontend runs on React or similar
